...
public class CampNPC_Elias : MonoBehaviour
{
    ...
    public float dialogueBreakDistance = 7f; // Â³äñòàíü, íà ÿê³é òåêñò îñòàòî÷íî çíèêàº

    private Transform playerTransform; // Êåøóºìî ãðàâöÿ
    ...
    private void Update()
    {
        ...
        else // --- ÍÎÂÀ ËÎÃ²ÊÀ ÏÅÐÅÐÈÂÀÍÍß ÏÎ ÄÈÑÒÀÍÖ²¯ ---
        {
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            // Ïðîñòî õîâàºìî ï³äêàçêó "Press E", àëå òåêñò ä³àëîãó ïðîäîâæóº éòè!
