...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // ŒÚËÏÛ∫ÏÓ Ì‡ÔˇÏÓÍ Í‡ÏÂË
        Vector3 camForward = Camera.main.transform.forward;
        Vector3 camRight = Camera.main.transform.right;
        camForward.y = 0f; camRight.y = 0f;
        camForward.Normalize(); camRight.Normalize();

        // --- 1. œŒ—“≤…Õ»… œŒ¬Œ–Œ“ «¿ Ã»ÿ Œﬁ ( ¿Ã≈–Œﬁ) ---
    ...
    private System.Collections.IEnumerator DashRoutine(Vector3 direction)
    {
        ...
        // 2. ¬¿∆À»¬Œ: ¬ËÏËÍ‡∫ÏÓ ÒÚ‡Ì Ë‚Í‡ ¬≤ƒ–¿«” Ô≥ÒÎˇ ÛıÛ, ˘Ó· Û‚≥ÏÍÌÛÎ‡Òˇ „‡‚≥Ú‡ˆ≥ˇ
        isDashing = false;

        // 3. œÀ¿¬Õ≈ œŒ¬≈–Õ≈ÕÕﬂ  ¿Ã≈–» (‚ÊÂ ·ÂÁ ·ÎÓÍÛ‚‡ÌÌˇ ÛıÛ)
        float elapsed = 0f;
