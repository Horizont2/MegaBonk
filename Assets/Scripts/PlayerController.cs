...
public class PlayerController : MonoBehaviour
{
    ...
    private System.Collections.IEnumerator SpawnSafely()
    {
        ...
        // ѕ≈–≈¬≤– ј “јЅќ–”: якщо ми в табор≥, завантажуЇмо координати ≥ виходимо
        if (isCampMode)
        {
    ...
    public void ExecuteAttack()
    {
        ...
        // ЎукаЇмо ¬—≤ об'Їкти в рад≥ус≥ (без жорсткого обмеженн€ по шару ворог≥в)
        ...
        foreach (Collider col in hitObjects)
        {
            ...
            // 2. ”дар по ресурсах (дерева, камен≥, бочки)
            else
            {
