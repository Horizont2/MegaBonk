...
public class PlayerController : MonoBehaviour
{
    ...
    private TrailRenderer weaponTrail; // <--- ÄÎÄÀÍÎ ØËÅÉÔ ÇÁÐÎ¯
    ...
    private void Start()
    {
        ...
        // Âèìèêàºìî øëåéô íà ñòàðò³, ùîá â³í íå ìàëþâàâñÿ, êîëè ãðàâåöü ïðîñòî ñòî¿òü
