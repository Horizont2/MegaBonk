...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // ÁËÎÊÓÂÀÍÍß ÊÅÐÓÂÀÍÍß Â ÊÀÒÑÖÅÍÀÕ
        if (!isControlBlocked)
        {
        ...
        if (inputDir.magnitude >= 0.1f)
        {
            // 3. Ìíîæèìî íàø íàïðÿìîê íà øâèäê³ñòü
